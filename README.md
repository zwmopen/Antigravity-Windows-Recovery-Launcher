...
<p align="center">
  <img src="https://img.shields.io/badge/版本-1.5.0-blue.svg" alt="版本 1.5.0" />
...
### 选项 A：绿色免安装版（推荐，解压即用）
1. 从 [最新发布页 (Releases)](https://github.com/zwmopen/Antigravity-Windows-Recovery-Launcher/releases/latest) 下载 [`Antigravity-Windows-Recovery-Launcher-1.5.0-windows-x64.zip`](https://github.com/zwmopen/Antigravity-Windows-Recovery-Launcher/releases/download/v1.5.0/Antigravity-Windows-Recovery-Launcher-1.5.0-windows-x64.zip)；
