...
assert.ok(contentSource.includes('ag-top-badge'));
assert.ok(contentSource.includes('applyTopConversationBadges'));
assert.ok(contentSource.includes('__AntigravityAutoResume'));
