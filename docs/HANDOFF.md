...
- 2026-09-08 (v1.4.11)：自证式交付与省力化契约、Windows 原生系统凭据直写、5小时主导门禁、通知防抖降噪与主动对账自愈里程碑。
  ...
  - **通知精准分级与 90 秒防抖熔断**：5% 配额预警仅弹桌面悬浮气泡，绝不发飞书；整套切换重启成功后同时发送桌面与飞书一条清晰战报；底层内置 90 秒同名通知防抖熔断器，物理杜绝刷屏打扰；
