...
- 2026-09-02 13:52–14:01：克制玻璃最终视觉复验通过，圆角黑边/锯齿已消除，动态进度显示正常；完整启动再次发现 17 条候选，Google/OAuth、US 出口和真实模型 OK 通过，Antigravity PID 23784 ready，language server PID 15048 建立 8 条 17897 连接，中文注入成功，7897 仍为 PID 8240。加入阶段内感知进度后全部策略/UI/中文/隔离测试再次通过；最终 0.8.0 ZIP 为 75,619 字节，SHA-256 `92D9F1D2B0A16CDABC56D1FA3D748C5C3E50C5CE9DA0F95DC36884A0070D2967`。
